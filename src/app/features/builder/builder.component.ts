...
import { ChangeDetectionStrategy, Component, ElementRef, Input, OnInit, QueryList, ViewChildren, effect, inject, signal } from '@angular/core';

import { Composite, Ingredient, Product } from '@modules/artisan/artisan.module';
import { EntityComponent } from '../entity/entity.component';
import { ComponentDirective } from '../artisan/component.directive';
...
export class Connector {
  ...
  private appendElement(...data: PathPoint[]): void {
    ...
    element.setAttribute('stroke', 'var(--connector-color)');
...
export class BuilderComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (!this.#canvas && this.#ref) {
      const connectors: HTMLElement = this.#ref.nativeElement;
      ...
      path.setAttribute('fill', 'var(--connector-color)');
